...
@section('tittle','Create Accessories')
@section('content')
<div class="box">
    <div class="box-header">
        <h3 class="box-tittle">Create New Accessories</h3>
    ...
    @endif
    <div class="box-body">
        {!! Form::open(array('route'=>'accessories.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img id="preview" src="{{asset('storage/noimageavailable.png')}}"
